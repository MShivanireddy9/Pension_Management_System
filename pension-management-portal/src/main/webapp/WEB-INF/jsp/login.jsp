...
<body
	style="background-image: url(https://c1.wallpaperflare.com/preview/683/917/263/pension-poverty-life-struggle-keep-house.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
	<header>
	...
	<div class="container">
		...
		<div class="float-right"
			style="margin-top: 100px; background-color: transparent; width: 400px; box-shadow: 5px 10px 8px 10px #888888; padding: 30px; border-radius: 5mm;">
<div class="text-center text-dark font-italic"
					style="margin-bottom: 25px;">
					<h2>Login</h2>
				</div>
			<form action="pensiondetail" method="POST">
				...
				<div class="form-group float-right"
					...
					<input id="submitBtn" name="submit" class="btn btn-success btn-outline-white"
